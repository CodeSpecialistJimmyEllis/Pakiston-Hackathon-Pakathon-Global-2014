...
{
    class OpeningTitleScreenThree : GameScreen
    {
        #region Fields
        ...
        //constructor 1
        public OpeningTitleScreenThree(bool choice)
        {
        ...
        // constructor 2 
        public OpeningTitleScreenThree()
        {
            backwardscode = new ScrollingBackgroundBackwardsTwo();
            virusplayer = new VideoPlayer();
            secondscreen = false;
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            */
            ...
            if (Keyboard.GetState(PlayerIndex.One).IsKeyDown(Keys.Enter))
            {
                ...
                ScreenManager.Instance.AddScreen(ScreenManager.paperrockscissorsstate);
                // not now readd  ScreenManager.Instance.AddScreen(new ResumeVideoGame());
            }
            #endregion
        }
        #endregion
