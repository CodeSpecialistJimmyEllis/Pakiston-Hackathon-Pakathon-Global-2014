...
namespace BlackStrength
{
    class ScreenManager
    {
        ...
        public static OpeningTitleScreen openingtitlescreen;
        ...
        public void Initialize()
        {
           ...
           // blockgameplay = new BlockGamePlay();
           // currentScreen = blockgameplay;

           paperrockscissorsstate = new PaperRockScissorsState();
          //  currentScreen = paperrockscissorsstate;


            openingtitlescreen = new OpeningTitleScreen();
            currentScreen = openingtitlescreen; 
